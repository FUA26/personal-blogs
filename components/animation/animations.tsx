      ...
      <div className="flex-1">
        {active === 0 ? (
          <WhyPanel>
            ...
            <p>
              Fumadocs offers native support for <b>Orama</b> and <b>Algolia Search</b>, it is as
              easy as plugging a route handler.
            </p>
        ...
        {active === 3 ? (
          <WhyPanel>
            <h3 className="mb-2 text-lg font-semibold">Interactive docs with React.</h3>
        ...
        {active === 4 ? (
          <WhyPanel>
            <h3 className="mb-2 text-lg font-semibold">Connect your content and server.</h3>
...
function WhyPanel(props: HTMLProps<HTMLDivElement>) {
  return (
    <div
      {...props}
      className={cn('animate-in fade-in slide-in-from-bottom-8 duration-700', props.className)}
    >
      {props.children}
    </div>
  )
